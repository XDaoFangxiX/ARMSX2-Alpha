...
private val BASE_EN: Map<String, String> = mapOf(
    ...
    "update.onNightly" to "You’re on a nightly build, so updates come through the nightly channel.",
    ...
    "app.bg.simple.desc" to "Use the lightweight 2D animated wave background instead of the 3D GL one. It's the same backdrop devices that can't run the 3D wave already use. Lighter on the GPU, and recolorable with the options above. No effect if you've set a custom background image.",
    ...
    "app.bootIntro.choose" to "Choose video",
    "app.bootIntro.current" to "Intro: %s",
    "app.bootIntro.default" to "Intro: ARMSX2 default",
    "app.bootIntro.reset" to "Use default",
    "app.bootIntro.set" to "Boot intro set. Tap Preview to watch it.",
    "app.bootIntro.preview" to "Preview",
    "app.bootIntro.importing" to "Copying video\u2026",
    "app.bootIntro.tooLarge" to "That video is over 200 MB. Pick a shorter clip.",
    "app.bootIntro.unreadable" to "Couldn't read that file. Your current intro is unchanged.",
    ...
    "fixes.disableDepthEmulation.desc" to "Disables depth emulation. Faster but breaks many games. Last resort only.",
    ...
    "fixes.section.display.help" to "PCRTC / presentation fixes for the displayed image. Anti-Blur is on by default.",
    ...
    "fixes.section.hardware.help" to "Manual renderer hacks. The master toggle auto-enables when any fix below is changed from its default.",
    ...
    "fixes.section.upscaling.help" to "Only active when upscaling above Native. They reduce alignment/seam artifacts that appear at higher resolutions.",
    ...
    "hotkeys.help" to "Bind physical buttons (back paddles work too) to in-game actions. Tap an action, then press the button.",
    ...
    "dataroot.unavailable.title" to "Data folder not available",
    "dataroot.unavailable.body" to "ARMSX2 can't open your data folder:\n%s\n\nYour memory cards and save states are still there. The SD card may not be mounted yet, or storage access may have been turned off.\n\nUsing internal storage instead shows a separate set of memory cards until the next launch.",
    "dataroot.unavailable.retry" to "Retry",
    "dataroot.unavailable.internal" to "Use internal storage this time",
    ...
    "overlay.intro.description" to "Show or hide parts of the performance overlay. Turning GPU off also stops the GPU timing it measures, which saves a little performance.",
    ...
    "pad.lightgun.help" to "Touch to aim and fire. Touching near a screen edge fires OFF-SCREEN, which is how these games reload. A/B/C, Start, Select and Cal (recalibrate) are on-screen buttons you can move and resize in the touch layout editor. If a setup screen asks you to shoot a target (Time Crisis), tap Cal first, then shoot the target.",
    ...
    "pad.gyro.tiltFallback.steering" to "No gyroscope found. Using the accelerometer. Tilt works normally for steering. Recenter to set the neutral position.",
    "pad.gyro.tiltFallback.aim" to "No gyroscope found. Using the accelerometer. Aim is tilt-based: twist to look left/right, tip to look up/down. Recenter to set the neutral position.",
    ...
    "patches.bundled.extracted" to "Copied. The bundled version is now ignored, so switch the cheats off individually above.",
    ...
    "gamedb.help" to "PCSX2's game database sets these for this game, on top of your own settings. Switch one off to keep your own setting for it instead.",
    "gamedb.state.off" to "Off: your own setting is used.",
    "gamedb.state.yourSetting" to "Off: a setting you changed for this game is used instead. Switch on to let the database decide it again.",
    "gamedb.state.autoFixesOff" to "Not applied while GameDB Fixes is off.",
    "gamedb.state.manualFixes" to "Not applied while any hardware fix is set by hand (Manual Hardware Fixes).",
    "gamedb.name.eeDivRoundMode" to "EE FPU Division Round Mode",
    "gamedb.name.vu0ClampMode" to "VU0 Clamping",
    ...
    "perf.vuClamping.description" to "VU float clamping for VU0, and VU1 unless VU1 Clamping overrides it. Exact adds the VU's own arithmetic and status flags on top of Extra+Sign: the most accurate and slowest setting. Restart the game to apply.",
    ...
    "ra.enable.label" to "Enable RetroAchievements",
    "ra.enable.thisGame" to "RetroAchievements for this game",
    "ra.enable.description" to "Unlocks, leaderboards and rich presence. Switches on or off straight away, no restart.",
    ...
    "network.mode.description" to "Online plays through the internet against game servers. Host and Join link this device with others directly, as if the consoles were wired to one switch. They're for the roughly 57 PS2 games that have a built-in LAN or System Link mode.",
    ...
    "renderer.shaderPack.companion.description" to "Ready-made presets built on top of the RetroArch pack's shaders. They install into it and need it first, since they contain no shaders of their own.",
    ...
    "setup.perf.ultraLowEnd" to "Ultra-Low-End",
    ...
    "touch.editor.pressureAmount" to "Pressure amount",
    "touch.editor.macroPressure" to "Macro pressure",
    ...
    "touch.editor.glideNeedsMulti" to "Glide (needs Multi-touch)",
